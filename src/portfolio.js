...
const greeting = {
  title: "Bharath Kumar",
  logo_name: "Bharath Kumar",
  nickname: "That Civil Engineer guy! ",
  subTitle:
    "As a civil engineer, I enjoy solving problems in the most unorthodox way and creating projects that the general public uses everyday.",
  resumeLink: "#",
...
const contactPageData = {
  ...
  addressSection: {
    ...
    location_map_link: "https://goo.gl/maps/BMKVscANA9wNaqXf7",
  },
  phoneSection: {
    title: "Phone Number",
